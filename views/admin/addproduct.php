    ...
    <div class="col-md-6">
        ...
        <form method="post" enctype="multipart/form-data" class="w-100" id="productForm">
            ...
            <div class="mb-3">
                ...
                <textarea name="description" class="form-control" oninput="updatePreview()"><?= htmlspecialchars($product['description'] ?? '') ?></textarea>
            </div>
    ...
    <div class="col-md-6 border-start ps-4">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-text" id="previewDesc"><?= nl2br(htmlspecialchars($product['description'] ?? '')) ?></p>
